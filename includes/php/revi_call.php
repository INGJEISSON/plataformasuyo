                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Observaciones de agendamiento de visitas:  <?php echo utf8_encode($datos['cliente']);  ?> - Ciudad: <?php echo utf8_encode($datos['ciudad']);  ?> </h3>
                    </div>
                    <div class="card-body">
                         ...
                         <table width="870" border="0" id="pan_add_revision" class="table responsive" cellpadding="1" cellspacing="4">
                           ...
                           <tr>
                             <td height="46"><select name="select" id="cod_estado" class="form-control">
                               ...
                               <option value="12">AgendaCallCenter</option>
                               <option value="13">AsesorAgenda</option>
                               <option value="14">Agendada</option>
                               <option value="15">No contesta</option>
                               <option value="16">Numero errado</option>
                               <option value="17">LLamar de nuevo</option>
                               <option value="17">LLamar de nuevo</option>
                               <option value="18">No interesado</option>
                               <option value="19">Cliente</option>
                             </select></td>
...
var datos='id_fasfield='+id_fasfield+'&cod_estado='+cod_estado+'&observacion='+observacion+'&add_revi_call='+1+'&tipo_seguimiento='+3;
...
var id_fasfield="<?php echo "$_GET[id_fasfield]" ?>";
var datos='id_fasfield='+id_fasfield+'&cod_estado='+cod_estado+'&observacion='+observacion+'&revi_revi_call='+1+'&tipo_seguimiento='+3;
