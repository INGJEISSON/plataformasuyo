...
$fecha_filtro=date('Y-m-d');
  ...
  $s="select distinct enc_procesadas.id_fasfield from enc_procesadas, det_repor_aseso where enc_procesadas.id_fasfield=det_repor_aseso.id_fasfield and (det_repor_aseso.resul_visita='Visitado y fue gratuito el diagnóstico' or det_repor_aseso.resul_visita='Visitado y se dejó factura (Quiere decir que paga luego, él solo)') ";
