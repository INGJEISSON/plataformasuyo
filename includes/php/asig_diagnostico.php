                              ...
                              var datos='asig_diagnostico='+1+'&cod_usu_resp='+cod_usu_resp+'&id_elab_diag='+id_elab_diag;
                                           ...
                                           $.ajax({
                                                    ...
                                                    success: function(valor){
                                                            ...
                                                            alert("Ocurri¨® un problema, comun¨ªcate con el administrador");
...
$(document).ready(function () {
 ...
 $.ajax({
            ...
            success: function(valor){
                 ...
                 /*if(valor==1){
                  /*  Push.create("DiagnÃ³sticos",{
                          body: "Tienes diagnÃ³sticos pendientes por revisar",
