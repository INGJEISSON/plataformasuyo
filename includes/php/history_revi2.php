<table width="1015" border="0" class="table responsive">
                            ...
                            <td><a href="edit_activi_diag.php?cod_activi_etapa=<?php echo $datos2['cod_activi_etapa'] ?>&id_activi_diag=<?php echo $datos2['id_activi_diag'] ?>&cod_equipo=1&observacion=<?php echo $datos2['observacion'] ?>&id_elab_diag=<?php echo $_POST['id_elab_diag'] ?>&tipo=<?php echo $_POST['tipo'] ?>&etapa=<?php echo $_POST['etapa'] ?>" target="_blank">Editar</a></td>
                             </tr>
                              <?php
                                $i++;
                              }
