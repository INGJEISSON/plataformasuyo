...
$cod_resp=0;
             if(isset($_POST['email'])){
                    ...
                    $parametro="";   
$sql="select  distinct cliente.cod_cliente, cliente.nombre, cliente.telefono_1, cliente.ciudad, cliente.barrio, tipo_cliente.descripcion as tipo_cliente from cliente, serv_cliente, tipo_cliente where $parametro cliente.tipo_cliente=tipo_cliente.tipo_cliente and cliente.cod_cliente=serv_cliente.cod_cliente and serv_cliente.cod_estado=24 ";
 ...
 <div class="row">
      ...
      $i=1;
        while($datos=pg_fetch_assoc($query)){
            ...
            $query2=pg_query($conexion, "select distinct id_serv_cliente from serv_cliente where cod_cliente='".$datos['cod_cliente']."' and cod_estado=24");
