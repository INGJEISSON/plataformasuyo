          ...
          <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-info">                   
                            ...
                            <?php if($_SESSION['tipo_usuario']==16 or $_SESSION['tipo_usuario']==15 or $_SESSION['tipo_usuario']==1 or $_SESSION['tipo_usuario']==2  or $_SESSION['tipo_usuario']==18){  ?><option value="Bogotá">Bogotá</option><?php  }  ?>
                           <?php if($_SESSION['tipo_usuario']==14 or $_SESSION['tipo_usuario']==15 or $_SESSION['tipo_usuario']==1 or $_SESSION['tipo_usuario']==2  or $_SESSION['tipo_usuario']==18){  ?> <option value="Cali">Cali</option><?php  }  ?>
  ...
  $('#fecha_1').datepicker({
      ...
      $("#buscar").click(function(){
            ...
            var tipo_informe=1;
                ...
                var datos='gene_dash_direct='+1+'&fecha_1='+fecha_1+'&fecha_2='+fecha_2+'&ciudad='+ciudad+'&tipo_informe='+tipo_informe;
